...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-horse-pops-plot width=70%}
...
![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse-pops-plot-largest width=70%}

<!-- Figure 2: Horse populations for the province with the largest standard deviation -->

In @fig-horse-pops-plot-largest we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
